...
plt.title('LSTM-MV(3) Model Predictions vs Actual Data')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('LSTM-MV(3) Validation Predictions vs Actual Data')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
# workbook = xlsxwriter.Workbook('lstmmv_training_and_testing_predictions.xlsx')
