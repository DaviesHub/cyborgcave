...
plt.title('GRU-UV(4) Model Predictions vs Actual Data')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('GRU-UV Validation Predictions vs Actuals')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
# workbook = xlsxwriter.Workbook('grusv_training_and_testing_predictions.xlsx')
