...
plt.title('CNN-UV(3) Model Predictions vs Actual Data')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('CNN-UV(3) Validation Predictions vs Actuals')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
plt.title('CNN-UV(3) Model Forecast vs Actual Data')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
# workbook = xlsxwriter.Workbook('cnnsv_training_and_testing_predictions.xlsx')
