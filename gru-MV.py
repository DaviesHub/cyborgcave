...
plt.title('GRU-MV(3) Model Predictions vs Actual Data')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('GRU-MV Validation Predictions vs Actuals')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
plt.title('GRU-MV(3) Model Forecasts vs Actual Data')
plt.xlabel('Batch Number')
plt.ylabel('Steam Demand (tonne)')
plt.grid(True)
plt.legend()
...
# workbook = xlsxwriter.Workbook('grumv_training_and_testing_predictions.xlsx')
